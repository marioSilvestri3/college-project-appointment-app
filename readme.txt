...
Directions: Unzip the package. Open the project folder in IntelliJ and run.

Additional Report: The additional report is a session activity log. Starting from login, the session activity log will record any deletes, updates, or additions of customers and appointments. Additionally, the session activity log records whenever the user accesses the reports screen.
